...
C++ 版エミュレータ上で [eembc/coremark](https://github.com/eembc/coremark) を使用して計測。
ビルド手順と詳細な結果は [Em68030_WinUI3Cpp ベンチマーク](https://github.com/hha0x617/Em68030_WinUI3Cpp/blob/main/docs/benchmark_ja.md#coremark-10) を参照。
